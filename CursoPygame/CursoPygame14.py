...
def game_thread(queue):
    ...
    while ejecutando:
        ...
        colision_personaje = pygame.sprite.spritecollide(jugador, spritesEnemigos, False, pygame.sprite.collide_circle) # spritecollide nos permite utilizar un sprite contra un grupo y ahí generamos una colisión, además aquí le indicamos que trabaje con colisiones circulares
        
        colision = pygame.sprite.groupcollide(spritesEnemigos, spritesBalas, False, True) # Para colisiones grupales, el False sirve para que cuando se cree la colisión no se eliminan los enemigos, y el True sirve para que se eliminen las balas cada vez que impacten en algún enemigo  
